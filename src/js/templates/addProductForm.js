function addForm()
{
  const template=`
          ...
          <form action="./viewproducts.html" method="post" class="product-form">
            <div class="product-details">
              <section>
                ...
                <div class="product-input">
                  ...
                  <input type="number" id="inventory" name="inventory" min="0" step="1" required>
                </div>
                <div class="product-input">
                ...
                <div class="product-input">
                  ...
                  <textarea name="shortDesc" id="shortDesc" placeholder="no more than 20 words" maxlength="160"></textarea>
                </div>
                <div class="product-input">
              ...
              <fieldset>
                ...
                <div>
                  <div class="display">
                    <img id="image1" src="#" alt="image" height="176" width="208" style="border-radius: 4px; display: none">
                  </div>
